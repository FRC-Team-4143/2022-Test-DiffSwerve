...
frc::SwerveModuleState AnalogDiffSwerveModule::GetState() {
    ...
    m_moduleAngle = (m_encoder.GetAbsolutePosition() - m_offset) * 2 * wpi::numbers::pi; //New analog encoder math
...
double AnalogDiffSwerveModule::SetDesiredState(const frc::SwerveModuleState& referenceState) {
...
void AnalogDiffSwerveModule::SetWheelOffset() {
	auto steerPosition{m_encoder.GetAbsolutePosition()}; //New analog encoder math
